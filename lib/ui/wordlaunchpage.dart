...
class _WordLaunchPageState extends State<WordLaunchPage> with SingleTickerProviderStateMixin {
  ...
  Widget getDrillPageCore(drillCategory) {
    if (widget.thirdPartyType != ThirdPartyType.yuwen) {
        ...
        onPressed: () {
          Navigator.push(
            ...
            MaterialPageRoute(
              builder: (context) =>
                  InputZiPage(typingType: TypingType.Custom,
                      lessonId: 0, wordsStudy: customString, isSoundPrompt: true, inputMethod: InputMethod.Pinxin, showHint: HintType.Hint3, includeSkipSection: false, showSwitchMethod: false) //InputZiPage(),
            ),
          );
        },
