        ...
        case 2:
          Navigator.push(
            ...
            MaterialPageRoute(
              builder: (context) =>
                  InputZiPage(
                      typingType: TypingType.Custom, lessonId: 0, wordsStudy: inputText, isSoundPrompt: false, inputMethod: InputMethod.Pinxin, showHint: 1, includeSkipSection: true, showSwitchMethod: true),
            ),
          ).then((val) => {_getRequests()});
          break;
        case 3:
