...
class _LessonsPageState extends State<LessonsPage> {
  ...
  List<Widget> getRowSections(BuildContext context, int lessonNumber, int lessonCount) {
    ...
    sections.add(Container(child: OpenHelper.getImageButton(context, lessonNumber, "assets/charactertree.png", false)));

    if (lessonCount >= 2) {
      sections.add(Container(child: OpenHelper.getImageButton(context, lessonNumber + 1, "assets/conversations.png", false)));

      if (lessonCount >= 3) {
        sections.add(Container(child: OpenHelper.getImageButton(context, lessonNumber + 2, "assets/charactertree.png", false)));
      }
    }
