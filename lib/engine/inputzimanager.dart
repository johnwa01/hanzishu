...
*/
  ...
  static String getEitherCharFromCurrentId(TypingType typingType,
    ...
    if (typingType == TypingType.ComponentTyping) {
      ...
      typingChar = theComponentCombinationCharsList[lessonId]
          .chars[currentIndex];
    }
    else {
  ...
  bool doesTypingResultContainTheZi(TypingType typingType, int currentIndex,
    ...
    //}
      ...
      var char = theComponentCombinationCharsList[lessonId]
          .chars[currentIndex];
      result = typingResult.contains(char);
    }
  ...
  int getTotal(TypingType typingType, int lessonId) {
    ...
    //}
      ...
      return theComponentCombinationCharsList[lessonId].chars
          .length;
    }
