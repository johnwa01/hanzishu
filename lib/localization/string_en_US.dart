...
var theString_en_US = [
  ...
  Local(97, "Components"),
  Local(98, "Hanzishu Chinese Input Method"),
  Local(99, "Please finish exercise 1 - 8 to learn the Chinese input method"),
  ...
  Local(109, "Try a few"),
  Local(110, "The Hanzishu Chinese Input Method breaks up a Chinese Character into Components and types in the mapped letters on the English keyboard."),
  ...
  Local(157, "Components are elements of a Character. The Hanzishu Chinese Input Method breaks Components into two types. Lead Components are the base Components. And each Lead Component houses a collection of sub-components called Expanded Components."),
  Local(158, "How it works"),
  Local(159, "The Hanzishu Chinese Input Method matches each Lead Component with a key on the English keyboard to create a Component-key pairing. Reference this chart to visualize how Lead Components are mapped to English letters."),
  ...
  Local(254, "Practice for typing the Character using the Hanzishu Chinese Input Method."),
  Local(255, "Quiz"),
  ...
  Local(260, "Typing"),
  Local(261, "Learn the Hanzishu Chinese Input Method and memorize the Component-key pairings."),
  ...
  Local(315, "square plus horizontal line"),
  Local(316, "which common shape"),
  Local(317, "containing a stroke with a few turns"),
  Local(318, "overall looking of the shape"),
  Local(319, "1st stroke or not fitting into others"),
  Local(320, "square plus a cross"),
  Local(321, "1st stroke or count of horizontal lines"),
  Local(322, "twisted triangle shape"),
  Local(323, "a curve crosses a horizontal line"),
  Local(324, "significant diagonal crosses"),
  Local(325, "separate or go left and right"),
  Local(326, "number of horizontal lines"),
  Local(327, "all but two first strokes are fold strokes"),
  Local(328, ""),
  Local(329, ""),
  Local(330, ""),
  Local(331, ""),
