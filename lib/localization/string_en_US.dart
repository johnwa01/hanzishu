...
var theString_en_US = [
  ...
  Local(79, "Dancing"),
  Local(80, "Pets"),
  Local(81, "Basic words (Components)"),
  Local(82, "Basic Non-words (Components)"),
  Local(83, "Words"),
  ...
  Local(109, "Try a few"),
  Local(110, "Let's try a few.\n\nFor example, to type a word '品', you break it up into components '口', '口', and '口', then type 'O', 'O', and 'O', then choose '品' from the candidate list below the editing field by typing its number or mouse/tap it.\n\nIf having difficulty, you can use [Hint] next to the word.\n\n"),
  ...
  Local(126, "The above chart shows the pairings of the Chinese alphabets to the English alphabets in a keyboard.\n\nLet's take a moment again to memorize the above pairings now since they won't show up in standard keyboard. After that, click 'Continue' to test it out.\n"),
  Local(127, ""),
  ...
  Local(131, "The above chart shows some Chinese alphabets which look similar to Chinese alphabet '日'（key B).\n\nThey share the same keyboard key with '日', just like English alphabet 'b' shares the same key with 'B'. Therefore, you simply type the same key 'B' for any of them.\n\nWe'll go through those Chinese alphabets."),
  ...
  Local(143, "The Hanzishu Dictionary is organized according to the first Basic word contained in a word. It houses nearly 3,800 Chinese words and 50,000 phrases, all listed under their corresponding Basic Character. Each number in the Basic Character Table represents the number of strokes for each Basic Character in that group."),
  Local(144, "Navigate the Hanzishu Dictionary"),
  Local(145, "Open the Basic word table"),
  Local(146, "Tap the first Basic word contained in the word that you are searching for"),
  Local(147, "Select the word from the list. Note: If it’s not there, the dictionary doesn’t support this word."),
  Local(148, "View the detailed information about the word"),
  Local(149, "Identify the word’s first Basic word"),
  Local(150, "Ex: Word 你 -> Basic word 小 (the first and only Basic word)"),
  Local(151, "If a word’s first Basic word is 口, but it contains other Basic words, select the next Basic word"),
  Local(152, "Ex: 听 -> 斤 (skip 口)"),
  Local(153, "If a word doesn’t contain any Basic words, select the stroke category of the word’s first stroke (first five in the first word chart)"),
  Local(154, "Ex: word 扎 -> Stroke 一 "),
  Local(155, "Ex: word 丝 -> Stroke 乙. Note: all fold strokes map to 乙."),
  Local(156, "What are Components?"),
  Local(157, "Components are elements of a word. The Hanzishu puzzle typing method breaks Components into two types， Lead Components and various Expanded Components. Each Lead Component houses a collection of Expanded Components."),
  ...
  Local(160, "According to the most significant characteristics of the Expanded Components, assign them to Lead Component-key pairings. To type in Chinese, first break a word into a sequence of Components， then the sequence of Components are converted into sequences of English letters to be entered into computer. For a character group, type the first two letters for each character."),
  ...
  Local(185, "Divide the word into components (Lead Components or various Expanded Components)."),
  ...
  Local(189, ""),
  Local(190, ""),
  Local(191, "If a word has two Components:"),
  Local(192, "Type the two Components first"),
  Local(193, "If the word doesn’t appear on the list, type up to two make-up keys (the first and second Supplementary Components of the second Component) until the Character appears"),
  Local(194, ""),
  Local(195, ""),
  Local(196, "If a word has three or more Components:"),
  Local(197, "Type as many Components as necessary in sequence until the word appears"),
  Local(198, "In action"),
  ...
  Local(231, "The components used to help to complete typing of words which contains only one or two Components."),
  ...
  Local(272, "Pencil"),
  Local(273, "Tap to draw the word or component"),
  Local(274, "Speaker"),
  ...
  Local(312, "Reminder: For a word containing a single component, first type the component, then if needed, you can continue to type up to three strokes of the character: 1st, 2nd and last stroke."),
  Local(313, "Reminder: For a word containing two components, first type the two components, then if needed, you can continue to type up to two strokes: the last stroke from the 1st component, and the last stroke from the 2nd component."),
  Local(314, "If there are two options to separate components, choose the option that contains a component with more strokes."),
  Local(315, "Mouth"),
  Local(316, "Horizontal line"),
  ...
  Local(323, "Line turning down"),
  Local(324, "Simple 'dots'"),
  Local(325, "Strange legs"),
  Local(326, "Two mouths"),
  Local(327, "Two mouths"),
  ...
  Local(335, "The rules of Chinese alphabet order in a word: top before bottom; left before right; outside before inside.\n\nThe rules to break up a word: only break up into alphabets; never break up two lines that are crossing through each other (ex: don't break up '十'); as fewer alphabets as possible (ex: '仿' - two alphabets instead of three), and in case of same number of alphabets, pick up the one containing more strokes in its first alphabet (ex: '百'， first alphabet contains two strokes instead of one.).\n\nLet's do some exercises.\n\n"),
  ...
  Local(355, "Congratulation! You have completed this puzzle typing course! You can redo it, do some 'Commonly used character typing exercises' or download Hanzishu puzzle typing app to use it."),
  ...
  Local(417, "For dictionary, puzzle typing, conversational lessons and more, choose the options from the bottom."),
  Local(418, "Phrases"),
