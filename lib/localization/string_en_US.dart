...
var theString_en_US = [
  ...
  Local(122, "The pairings are divided into six groups (based on the first Stroke of each Component). Five single-stroke ZiGroupPages are located in the middle, therefore remember each group from middle to two sides."),
  ...
  Local(177, "DO break up with Components positioned earlier as many strokes as possible（separated ZiGroupPages can be exception)."),
