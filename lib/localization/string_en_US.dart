...
var theString_en_US = [
  ...
  Local(97, "Components"),
  Local(98, "Hanzishu Input Method"),
  Local(99, "Learn Hanzishu typing method through 10 exercises \n\n[Please make sure your computer/phone is under English input mode."),
  ...
  Local(157, "Components are elements of a Character. The Hanzishu Input Method breaks Components into two types， Lead Components and various Expanded Components. Each Lead Component houses a collection of Expanded Components."),
  Local(158, "How it works"),
  Local(159, "The Hanzishu Input Method matches each Lead Component with a key on the English keyboard to create a Component-key pairing. Reference this chart to visualize how Lead Components are mapped to English letters."),
  ...
  Local(236, "Hanzishu Typing Method"),
  ...
  Local(238, "A separate general purpose IME app for the typing method to be used by other programs is available for Windows and Mac computers now."),
  ...
  Local(244, "Please return to this section once you have mastered the Hanzishu Input Method."),
  ...
  Local(254, "Practice for typing the Character using the Hanzishu Input Method."),
  Local(255, "Quiz"),
  ...
  Local(259, "Reference the Dictionary as you learn the Hanzishu Input Method and complete the lessons."),
  Local(260, "Typing"),
  Local(261, "Learn the Hanzishu Input Method and memorize the Component-key pairings."),
  ...
  Local(377, "seconds"),
  Local(378, "English"),
  Local(379, "Hanzishu pinxing typing app"),
  Local(380, "Currently the general purpose Hanzishu pinxing typing app is only available for Windows and Mac computers. That means, after installing the app, all other programs can use this typing method."),
