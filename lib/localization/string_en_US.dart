...
var theString_en_US = [
  ...
  Local(98, "Hanzi puzzle typing method"),
  ...
  Local(108, "Editor"),
  Local(109, "Try a few"),
  Local(110, "Let's try to type a few Hanzi.\n\n\Note: By default, it will show Hint1 which will break up Hanzi for you and highlight a Chinese alphabet for you to type. If you are not sure about which letter to type, you can ask Hint to help by guess clicking one of the five listed groups of Chinese alphabets, a green color indicates a correct guess, and a red color indicates a wrong guess. Then you can further guess clicking which type of Chinese alphabet it is. And 'Hint2' would tell you the whole answer and 'No' will show no hint."),
  ...
  Local(511, "Puzzle Typing intro"),
  Local(512, "You have typed your first Hanzi '品' into computer!"),
  Local(513, "In this four-step typing course, you will learn how to type Hanzi (Chinese character) into computer using Hanzishu Puzzle Typing method.\n\nStep1:\n\nQuestion: How can I type Hanzi '品' into computer?\n\nAnswer: You break up '品' into '口'，'口'，and '口'， then type 'o', 'o', and 'o'. \n\nThat is, map Chinese alphabet '口' into upper case letter 'O' according to shape similarity and type lower case letter. Then choose '品' from a candidate list below the editing field by typing its number, mouse clicking, tapping it, or using space bar to choose the 1st candidate."),
  Local(514, "Step 2:\n\nQuestion: Can I map other Chinese alphabets to letters as well?\n\nAnswer: Yes. You can map all 25 types of Chinese alphabets to 25 upper case letters by shape similarity.\n\nLet's go through the mappings by five groups now."),
];