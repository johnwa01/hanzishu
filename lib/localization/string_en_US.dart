...
var theString_en_US = [
  ...
  Local(315, "One mouth"),
  Local(316, "Horizontal lines as the main strokes"),
  ...
  Local(339, "Part 5:\n\nQuestion: To speed up，can I type more letters for Chinese words with only single or two alphabets like '日' or '叶'?\n\nAnswer: Yes. For word '日'， after you type its only alphabet '日' as usual, then if you want, you can continue to type up to two makeup alphabets of '日', which are '口' and '一'. That is, for word '日', you can type 日(B), 口(O), 一(E).\n\nThe so called makeup alphabets are just subset of a alphabet that we use to speed up single or double alphabet words. Note that word '日' contains only alphabet '日', while '口' and '一' are makeup alphabets, not regular alphabets of word '日'.\n\nFor '叶'， you can get two make up alphabets from its second alphabet '十' by breaking up cross strokes into '一' and '丨' when there is no other options.\n\n"),
  ...
  Local(342, "Vertical line(s) as the main stroke(s)"),
  ...
  Local(355, "Congratulation! You have completed this puzzle typing course! You can redo it, do some 'Commonly used character typing exercises', use editor here, or download general purpose Hanzishu puzzle typing program."),
  ...
  Local(395, "All commonly used Hanzi [3,800 words]"),
