...
var theString_en_US = [
  ...
  Local(99, "Learn Hanzishu puzzle typing method through nine exercises \n\n[Please make sure your computer/phone is under English input mode."),
  ...
  Local(131, "The above chart shows the Components associated with the Lead Component '日'（key B). They look similar to their Lead Component and type the same key (letter B).\n\nWe'll go through the Components for each Lead Component/key."),
  ...
  Local(336, "Let's do some typing exercises with the components you just learned.\n\n"),
  ...
  Local(377, "seconds"),
  Local(378, "English"),
  Local(379, "Genernal purpose Hanzishu puzzle typing app"),
