...
var theString_en_US = [
  ...
  Local(126, "The above chart shows the pairings of the Lead Components of Chinese characters to the English letters in a keyboard. The two types share a lot of similarities. The pairings are the foundation of the Quanzi Input Method！\n\nLet's take a moment to memorize the above Component-key pairings. After that, click 'Start' to test it out.\n\n\Note: Like English, a horizontal line in Chinese can only go from left to right, and a vertical line can only go from top to bottom.\n\nHints: W = three (peaks), M = three legs, V = split, D = toward left, K = crossing in the middle, H = the horizontal line, Y = the first stroke."),
  Local(127, ""),
