...
var theString_en_US = [
  ...
  Local(335, "Over 80% of the characters are consisted of the Expanded Components. Remember them well will speed up the typing process.\n\nThe following chart shows the Expanded Components of the Lead Component '' (letter X). We'll review all the Lead Components.\n\n"),
  Local(336, "A Lead/Expanded Component might contain some Attached Components. Use the same key of the component to type the Attached Components. \n\nThe following chart shows the components in key 'J' that own some Attached Components. We'll go through them one key at a time.\n\n"),
  Local(337, "A Lead/Expanded Component might contain some Twin Components, which look almost same. Use the same key of the component to type the Twin Components. \n\nThe following chart shows the components in key 'J' that own some Twin Components. We'll go through them one key at a time.\n\n"),
  Local(338, "A Lead/Expanded Component might contain some subsets which are also Components. We call these subsets within a component Sub Components, although they are also Components by definition. Use the same key of the component to type those Sub Components. \n\nThe following chart shows the components in key 'J' that contains Sub Components. We'll go through them one key at a time.\n\n"),
  Local(339, "For a character containing only one component, first type the component. \n\nThen type the first two subcomponents of the component. For character '一' and '乙', after typing the component, just type its subcomponent twice. We'll go through one example for each key.\n\n"),
  Local(340, "For a character containing two components, first type the two components. \n\nThen type the first two subcomponents of the second component. We'll go through one example for each key.\n\n"),
  Local(341, "You have learned everything. Let's do some general exercises to enforce the learning.\n\n"),
