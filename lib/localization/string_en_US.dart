...
var theString_en_US = [
  ...
  Local(99, "Please finish exercise 1 - 7 to learn the input method"),
  Local(100, "Give it a try"),
  Local(101, "Component-key pairing groups"),
  Local(102, "Memorize by groups"),
  Local(103, "Memorize the pairings"),
  Local(104, "Guided typing"),
  Local(105, "Expanded Components"),
  Local(106, "Typing exercises"),
  Local(107, "[Optional] Customized exercises"),
  ...
  Local(111, "Reference this chart to visualize how Lead Components are mapped to English letters. The five single-stroke Components sit in the two middle columns, so try to read from middle to side."),
  ...
  Local(122, "The pairings are divided into six groups (based on the first Stroke of each Component). Five single-stroke components are located in the middle, therefore remember each group from middle to sides."),
  ...
  Local(126, "Memorize the above Component-key pairings."),
  Local(127, "Memorize the above Component-key pairings."),
  Local(118, "Map the Component to its key."),
  Local(129, "Guess the Lead Component and corresponding key for these Expanded Components."),
  Local(130, "Match above Component group to its key group."),
  Local(131, "This chart shows the Expanded Components for Lead Component 日（key O). To type an Expanded Component, just type its Lead Component 日（key O)."),
  Local(132, "Note: The Expanded Components have similar shapes to their Lead Component."),
  ...
  Local(136, "Wow!"),
  Local(137, "You know your Expanded Components! Let’s practice with some typing exercises."),
  Local(138, "Next"),
  ...
  Local(146, "Tap the first Basic Character of the Character that you are searching for"),
  ...
  Local(153, "If a Character doesn’t contain any Basic Characters, select the Character’s first stroke (in group 1)"),
  ...
  Local(157, "Components are elements of a Character. The Hanzishu Component Input Method breaks Components into two types. Lead Components are the base Components. And each Lead Component houses a collection of sub-components called Expanded Components."),
  Local(158, "How it works"),
  Local(159, "The Hanzishu Component Input Method matches each Lead Component with a key on the English keyboard to create a Component-key pairing. Reference this chart to visualize how Lead Components are mapped to English letters."),
  Local(160, "Expanded Components are grouped under each Lead Component-key pairing. To type in Chinese, Components are grouped into sequences of English letters. Each sequence of Components creates a Character."),
  Local(161, "The Typing section of this app will:"),
  ...
  Local(165, "Help you practice with guided and free typing"),
  ...
  Local(181, "During typing, select Shift+z to show the Component-key pairings. Select Shift+ any key (except z) to show the Expanded Components."),
  ...
  Local(190, "Treat all fold Strokes as a Component 乙"),
  ...
  Local(226, "Select Shift+z to show the Component-key pairings while typing."),
  ...
  Local(229, "Select Shift+ any key except z to show the Expanded Components while typing."),
  ...
  Local(238, "A separate IME app for the input method to be used by other programs is under development and could be released at any time."),
  ...
  Local(244, "Return to this section once you have mastered the Component Input Method."),
  ...
  Local(272, "Pencil"),
  Local(273, "Tap to see the Character drawn"),
  Local(274, "Speaker"),
  Local(275, "Tap to hear the Character"),
  ...
  Local(289, "Practice typing 3,800 Characters in 38 exercises"),
