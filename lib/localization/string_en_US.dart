...
var theString_en_US = [
  ...
  Local(535, "Hanzishu\nInput Method"), // Typing
  Local(536, "Hanzishu Cup Hanzi Input Competition Warm Up Exercises"),
  ...
  Local(540, "Note：You will open a new 'answer sheet' web page, and start the clock and fill out your personal information there. You will Then click this red star area as shown in the following picture to come back to the 'typing' web page to start game typing."),
  Local(541, "Note: If the following action can't open the 'answer sheet' web page, you can open it yourself with following address："),
  Local(542, "Open answer sheet web page."),
  Local(543, "1. Make sure your input mode is set at: "),
  Local(544, "2. Start the Game"),
  Local(545, "Please Type"),
  Local(546, "Question"),
  Local(547, "After finishing typing, do following:"),
  Local(548, "1. Copy/paste typed content to answer sheet."),
  Local(549, "2. Copy/paste following verification code to answer sheet."),
  Local(550, "3. Next question"),
