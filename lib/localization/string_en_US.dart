...
var theString_en_US = [
  ...
  Local(151, "c. If the target word doesn’t contain any word radical, tap the stroke radical corresponding to the word's first stroke (The first five radicals in table are the stroke radicals)."),
