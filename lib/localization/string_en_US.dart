...
var theString_en_US = [
  ...
  Local(109, "Try a few"),
  Local(110, "The Quanzi Input Method breaks up a Chinese Character into Components and types in the mapped letters on the English keyboard.\n\nFor example, to type character '晶', you break it into components '日', '日', and '日', then type 'B', 'B', and 'B', then choose '晶' from the candidate list below the editing field by typing its number or mouse/tap it.\n\nThe rules to break up a character: never break up two lines that are crossing through each other (ok for separated or touching lines); as fewer components as possible; components in earlier positions as big as possible (separated shapes don't have to follow this).\n\nIf having difficulty, you can use [Hint] next to the character.\n\n"),
