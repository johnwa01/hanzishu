...
var theString_en_US = [
  ...
  Local(342, "vertical stroke as the starting stroke"),
  Local(343, "Open to northeast"),
  Local(344, "Horizontal stroke as the starting stroke"),
  Local(345, "Open to north"),
  ...
  Local(355, "You have completed all the exercises in this typing course! You can redo it, do some 'customized typing exercises' or download Hanzishu puzzle typing app to use it."),
  ...
  Local(377, "seconds"),
  Local(378, "English"),
  Local(379, "Download Hanzishu puzzle typing app"),
  ...
  Local(383, "Before moving to the next one, suggest you repeat this exercise until you cann't type faster."),
  Local(384, "Hanzi basic components"),
  Local(385, "Name"),
  Local(386, "group"),
  Local(387, "Up to unit"),
  Local(388, "Please learn and remember above general component categories carefully. It's the foundation of this method!."),
