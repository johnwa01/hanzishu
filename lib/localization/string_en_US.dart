...
var theString_en_US = [
  ...
  Local(339, "For a character containing only one component, first type the component. Then break up the component into smaller components (called Supplementary Components) and type in the first two Supplementary Components as supplementary keys.\n\nThe rules for breaking up a Component into Supplementary Components are same as for breaking up a character into Components, except you can break lines that are crossing through each other if you have no other options.\n\nFor example, to type a single-component character '吏', first type Component '吏'(O), then break up '吏' into Supplementary Components '一' and '史', then type in '一'(H) and '史'(O). We'll go through some exercises.\n\nDuring breaking up of a Component, a few strokes and shapes are not Components, and we match them to the closest Components as shown below."),
  ...
  Local(363, "If there are no other options, you can break up crossing strokes"),
  Local(364, "A few fold strokes and a shape should be treated as the closest Components as shown in the table below"),
