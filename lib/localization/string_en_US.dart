...
var theString_en_US = [
  ...
  Local(107, "Commonly Used Hanzi"),
  Local(108, "Web Editor"),
  Local(109, "Try a few"),
  ...
  Local(114, "Help"),
  Local(115, "Good job!"),
  Local(116, "You did it!"), //"You did it! Let's go through the Chinese alphabet-key pairings now."),
  ...
  Local(157, "Components are elements of a word. The Hanzishu pictographic input method breaks Components into two types， Lead Components and various Expanded Components. Each Lead Component houses a collection of Expanded Components."),
  Local(158, "How it works"),
  Local(159, "The Hanzishu pictographic input method matches each Lead Component with a key on the English keyboard to create a Component-key pairing. Reference this chart to visualize how Lead Components are mapped to English letters."),
  ...
  Local(161, "The Hanzishu pinxing input method section of this app will:"),
  Local(162, "Introduce you to Lead Components & various Expanded Components"),
  Local(163, "Teach you the Component-key pairings and input method"),
  ...
  Local(236, "Hanzishu pictographic input method"),
  ...
  Local(238, "A separate general purpose IME app for the input method to be used by other programs is available for Windows and Mac computers now. Phone versions are close to complete."),
  ...
  Local(244, "Please return to this section once you have mastered the Hanzishu pictographic input method."),
  ...
  Local(254, "Practice for typing the word using the Hanzishu pictographic input method."),
  Local(255, "Quiz"), // Quiz
  ...
  Local(259, "Reference the Dictionary as you learn the Hanzishu pictographic input method and complete the lessons."),
  Local(260, "Typing"),
  Local(261, "Learn the Hanzishu pictographic input method and memorize the Component-key pairings."),
  ...
  Local(317, "Open right mouth"),
  Local(318, "Throw away"),
  Local(319, "T shape"),
  Local(320, "Ear"),
  Local(321, "Triangle"),
  Local(322, "Three legs"),
  Local(323, "Open left mouth"),
  Local(324, "W shape"),
  Local(325, "Left & right legs"),
  Local(326, "Knife"),
  Local(327, "Up & down mouth"), //Up & down mouths
  ...
  Local(342, "Vertical lines"),
  Local(343, "Break"),
  Local(344, "Grass"),
  Local(345, "Open up mouth"),
  Local(346, "K shape"),
  Local(347, "Separated legs"),
  Local(348, "Open down mouth"),
  Local(349, "Cliff"), // F
  ...
  Local(377, "seconds"),
  Local(378, "English"),
  Local(379, "Download Hanzishu Input Program"),
  Local(380, "Currently the general purpose Hanzishu pictographic typing app can be downloaded for Windows and Mac computers through http://github.com/hanzishu    That means, after installing the app, all other programs can use this input method."),
  ...
  Local(394, "Block Hanzi"), //"Hanzishu word puzzle", Literacy Tree
  ...
  Local(404, "Study until all are checked"),
  Local(405, "Previous"),
  ...
  Local(413, "Single component Hanzi"), //"Typing exercises by component characteristics"
  ...
  Local(436, "Hazishu pictographic input method and Chinese teaching"),
  Local(437, "Pinyin does no good to international Chinese teaching"),
  Local(438, "Hint2"),
  Local(439, "Introduction to Hanzishu Pictographic Input Method"),
  Local(440, "Hanzi structure"),
  Local(441, "Single part"),
  Local(442, "Left & right"),
  Local(443, "Up & down"),
  Local(444, "Wrapped"),
  Local(445, "Chinese component count"),
  Local(446, "Breakdown"),
  ...
  Local(482, "Stories"),
  Local(483, ""),
  Local(484, "Your own preferred input method"),
  Local(485, "Hanzishu Pictographic input method"),
  ...
  Local(494, "Pictographic input method"),
  ...
  Local(517, "Ty & Od Textbook Typing"),
  ...
  Local(528, "Chinese Made Easy"),
  Local(529, "Basic Exercises"),
  ...
  Local(544, "2. Start typing Task 1"),
  Local(545, "Please Type"),
  Local(546, "Task"),
  Local(547, "After finishing typing, do following:"),
  Local(548, "1. Copy/paste typed content to answer sheet."),
  Local(549, "2. Copy/paste following description line to answer sheet."),
  Local(550, "3. Next task"),
  Local(551, "Hanzishu Cup Hanzi Input Competition"),
  Local(552, "Congrats for finishing one Hanzishu Cup competition! Don't forget to submit the answer sheet!"),
  Local(553, "English"),
  Local(554, "Pinyin"),
  Local(555, "Pinyin Input Method"),
  ...
  Local(567, "The Shape Sequence Approach"),
  Local(568, "Explore Hanzi through Shape-Sequence relationships"),
  ...
  Local(573, "Articles, videos, research, and classroom stories"),
  Local(574, "View All →"),
  Local(575, "Learn Chinese through lessons"),
  Local(576, "Hanzishu Lessons"),
  Local(577, "Start Lesson"),
  Local(578, "Choose the correct meaning"),
  Local(579, "Please switch your computer or phone to "),
  Local(580, "English input mode"),
  Local(581, ".\nHanzishu pictographic input is built into this website."),
  Local(582, "Learn, practice, and use the Hanzishu Input Method."),
  Local(583, "Learn the 25 pictographic categories and type any Hanzi."),
  Local(584, "30-minute guided tutorial"),
  Local(585, "Recommended for all new users"),
  Local(586, "2. PRACTICE TYPING"),
  Local(587, "Build speed and confidence through guided practice."),
  Local(588, "Customized Typing Exercises"),
  Local(589, "★ MAIN PRACTICE TOOL"),
  Local(590, "Paste your own text or content and start practicing right away."),
  Local(591, "Start from the basics.\nImprove step by step."),
  Local(592, "Practice simple\ncomponent Hanzi."),
  Local(593, "Practice the most\ncommonly used Hanzi."),
  Local(594, "GENERAL PRACTICE"),
  Local(595, "TEXTBOOK PRACTICE"),
  Local(596, "Practice with Chinese\nMade Easy content."),
  Local(597, "Practice with Yuwen\ntextbook content."),
  Local(598, "Practice with Ty & Od\ntextbook content."),
  Local(599, "3. USE THE INPUT METHOD"),
  Local(600, "Apply the Hanzishu Input Method to real-world typing."),
  Local(601, "Use Hanzishu directly\nin your browser."),
  Local(602, "Use Hanzishu in Word, Excel,\nand other applications."),
  Local(603, "ADDITIONAL RESOURCES"),
  Local(604, "★ MAIN TOOL"),
  Local(605, "Background, features and benefits of the Hanzishu Input Method."),
  Local(606, "Need help? Check the Tutorial first. It will answer 90% of your questions."),
  Local(607, "1. START HERE"),
  Local(608, "Start Tutorial"),
  Local(609, "Your First\nChinese Characters"),
  Local(610, "Start ->"),
  Local(611, 'English keys to represent Chinese components'),
  Local(612, "Start Learning"),
  Local(613, "You typed your first\nthree Chinese characters."),
  Local(614, "Great Start!"),
  Local(615, "Step 1 Complete"),
  Local(616, "English keys to represent Chinese components"),
  Local(617, "Choose the matching key"),
  Local(618, "Learn mapping in this group"),
  Local(619, "Review the 25 mappings"),
  Local(620, "Step 2 Complete"),
  Local(621, "More common components ->"),
  Local(622, "25 keys for common components"),
  Local(623, "Similar Shapes, Same Key"),
  Local(624, "Tap the matching key below."),
  Local(625, "Great Job!"),
  Local(626, "Step 3 Complete"),
  Local(627, "Start Hanzi Decomposition"),
  Local(628, " out of "),
  Local(629, " correct!"),
  Local(630, "Top-left to Bottom-right"),
  Local(631, "Start Study"),
  Local(632, "Left/right structure: Left to Right"),
  Local(633, "Top/bottom structure: Top to Bottom"),
  Local(634, "Inside/outside structure: Outside to Inside"),
  Local(635, "Mixed structure: Left to Right, then Top to Bottom"),
  Local(636, "Mixed structure: Top to Bottom, then Left to Right"),
  Local(637, "Split to Components Only"),
  Local(638, "Keep single-body structure, Keep Crossed Strokes"),
  Local(639, "Finish"),
  Local(640, "Amazing!"),
  Local(641, "Step 4 complete"),
  Local(642, "You have learned how to decompose Hanzi!"),
  Local(643, "Start to practice typing Hanzi ->"),
  Local(644, "Practice Typing Chinese Characters"),
  Local(645, "Let's Type!"),
  Local(646, "Start Practice"),
  Local(647, "Tutorial Complete"),
  Local(648, "First-Hanzi Search"),
  Local(649, "Find a Hanzi through its first Hanzi"),
  Local(650, "Open First-Hanzi Table"),
  Local(651, "Search Hanzi"),
  Local(652, "Choose a search method"),
  Local(653, "Search with Hanzishu Input"),
  Local(654, "Enter a Shape-Sequence code"),
  Local(655, "Search with Other Input Methods"),
  Local(656, "Use Pinyin or other input methods"),
  Local(657, "Enter Shape-Sequence code..."),
  Local(658, "Enter Pinyin or other input..."),
  Local(659, "All 3,800\nCommon Hanzi"),
  Local(660, "Explore the complete set\nof common Hanzi"),
  Local(661, "HSK Hanzi"),
  Local(662, "Practice by\nHSK level"),
  Local(663, "Customized Hanzi"),
  Local(664, "Learn from\nyour own text"),
  Local(665, "Yuwen Textbook"),
  Local(666, "Study Hanzi from\nYuwen textbooks"),
  Local(667, "Choose the correct meaning"),
  Local(668, "Listen and choose the Hanzi"),
  Local(669, "See Hanzi and choose its sound"),
  Local(670, "Block Hanzi"),
  Local(671, "Build and explore characters from components"),
  Local(672, "Choose the correct Hanzi"),
  Local(673, "Tap speakers to listen, then choose A, B, or C"),
  Local(674, "Practice Hanzi by official HSK levels"),
  Local(675, "Progressive difficulty"),
  Local(676, "Advanced proficiency"),
  Local(677, "Randomized challenge mode"),
  Local(678, "Try these ideas"),
  Local(679, "•  Lesson content"),
  Local(680, "•  Short stories"),
  Local(681, "•  Competition passages"),
  Local(682, "•  Chinese articles"),
  Local(683, "Paste Chinese text, stories, articles, or lesson content to create your own typing exercise."),
  Local(684, "Content"),
  Local(685, "characters"),
  Local(686, "Your text is used only for practice and not stored."),
  Local(687, "Practice any text with Hanzishu"),
  Local(688, "Practice with Yuwen"),
  Local(689, "Practice with Chinese Made Easy"),
  Local(690, "Practice with Ty & Od Textbook"),
  Local(691, "Practice with Yuwen textbook content"),
  Local(692, "Practice with the Chinese Made Easy content"),
  Local(693, "Practice with lessons from the Ty & Od Chinese textbooks."),
  Local(694, "Review each Hanzi with details"),
  Local(695, "Practice typing the Hanzi"),
  Local(696, "Listen first, then type Hanzi"),
  Local(697, "Study customized Hanzi together"),
  Local(698, "Settings & Support"),
  Local(699, "Learn"),
  Local(700, "Tools"),
  Local(701, "Paste Chinese text to instantly create flashcards"),
