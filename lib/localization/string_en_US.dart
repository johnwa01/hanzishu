...
var theString_en_US = [
  ...
  Local(143, "The Hanzishu Dictionary is organized according to radicals based on the basic character-forming components (roughly single body words). Its main characteristic in the fact that the radical of each word is the the first radical the word contains. It houses nearly 3,800 Chinese words and 50,000 phrases."),
  Local(144, "How to search a target word"),
  Local(145, "1. Enter the main page of the dictionary - Open the radical table. (The numbers in the Table represent the numbers of strokes of radicals.)"),
  Local(146, "2. Choose radical"),
  Local(147, "a. If the target word contains both radical '口' and other radicals, tap the first other radicals;"),
  Local(148, "ex: For Word '听', its first radical is '斤' (skip '口')"),
  Local(149, "b. If the target word contains radicals, tap the first radical;"),
  Local(150, "Ex: For Word '涨', its first radical is '弓'"),
  Local(151, "If the target word doesn’t contain any word radical, tap the stroke radical corresponding to the word's first stroke (The first five radicals in table are the stroke radicals)."),
