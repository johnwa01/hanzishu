...
var theThirdPartyLessonList = [
  ...
  ThirdPartyLesson(ThirdPartyType.yuwen2017, 4, 11, "7. 一匹出色的马"),
  ThirdPartyLesson(ThirdPartyType.yuwen2017, 4, 12, "D. 识字加油站"),
  ThirdPartyLesson(ThirdPartyType.yuwen2017, 4, 13, "E. 日积月累"),
  ThirdPartyLesson(ThirdPartyType.yuwen2017, 4, 14, "F. 一株紫丁香"),
  ThirdPartyLesson(ThirdPartyType.yuwen2017, 4, 15, "G. 神州谣"),
  ThirdPartyLesson(ThirdPartyType.yuwen2017, 4, 16, "H. 传统节日"),
  ThirdPartyLesson(ThirdPartyType.yuwen2017, 4, 17, "I. 贝的故事"),
  ThirdPartyLesson(ThirdPartyType.yuwen2017, 4, 18, "J. 中国美食"),
  ThirdPartyLesson(ThirdPartyType.yuwen2017, 4, 19, "K. 汉字加油站"),
  ThirdPartyLesson(ThirdPartyType.yuwen2017, 4, 20, "L. 日积月累"),
  ThirdPartyLesson(ThirdPartyType.yuwen2017, 4, 21, "M. 小柳树和小枣树"),
  ThirdPartyLesson(ThirdPartyType.yuwen2017, 4, 22, "8. 彩色的梦"),
  ThirdPartyLesson(ThirdPartyType.yuwen2017, 4, 23, "9. 枫树上的喜鹊"),
  ThirdPartyLesson(ThirdPartyType.yuwen2017, 4, 24, "10. 沙滩上的童话"),
  ThirdPartyLesson(ThirdPartyType.yuwen2017, 4, 25, "11. 我是一只小虫子"),
  ThirdPartyLesson(ThirdPartyType.yuwen2017, 4, 26, "N. 识字加油站"),
  ThirdPartyLesson(ThirdPartyType.yuwen2017, 4, 27, "O. 日积月累"),
  ThirdPartyLesson(ThirdPartyType.yuwen2017, 4, 28, "P. 手影戏"),
  ThirdPartyLesson(ThirdPartyType.yuwen2017, 4, 29, "12 (A). 亡羊补牢"),
  ThirdPartyLesson(ThirdPartyType.yuwen2017, 4, 30, "12 (B). 揠苗助长"),
  ThirdPartyLesson(ThirdPartyType.yuwen2017, 4, 31, "13. 画杨桃"),
  ThirdPartyLesson(ThirdPartyType.yuwen2017, 4, 32, "14. 小马过河"),
  ThirdPartyLesson(ThirdPartyType.yuwen2017, 4, 33, "Q. 日积月累"),
  ThirdPartyLesson(ThirdPartyType.yuwen2017, 4, 34, "R. 好天气和坏天气"),
  ThirdPartyLesson(ThirdPartyType.yuwen2017, 4, 35, "15 (A). 晓出净慈寺送林子方"),
  ThirdPartyLesson(ThirdPartyType.yuwen2017, 4, 36, "15 (B). 绝句 唐 杜甫"),
  ThirdPartyLesson(ThirdPartyType.yuwen2017, 4, 37, "16. 雷雨"),
  ThirdPartyLesson(ThirdPartyType.yuwen2017, 4, 38, "17. 要是你在野外迷了路"),
  ThirdPartyLesson(ThirdPartyType.yuwen2017, 4, 39, "18. 太空生活趣事多"),
  ThirdPartyLesson(ThirdPartyType.yuwen2017, 4, 40, "S. 悯农"),
  ThirdPartyLesson(ThirdPartyType.yuwen2017, 4, 41, "T. 最大的书"),
  ThirdPartyLesson(ThirdPartyType.yuwen2017, 4, 42, "19. 大象的耳朵"),
  ThirdPartyLesson(ThirdPartyType.yuwen2017, 4, 43, "20. 蜘蛛开店"),
  ThirdPartyLesson(ThirdPartyType.yuwen2017, 4, 44, "21. 青蛙卖泥塘"),
  ThirdPartyLesson(ThirdPartyType.yuwen2017, 4, 45, "22. 小毛虫"),
  ThirdPartyLesson(ThirdPartyType.yuwen2017, 4, 46, "U. 二十四节气歌"),
  ThirdPartyLesson(ThirdPartyType.yuwen2017, 4, 47, "V. 月亮姑娘做衣裳"),
  ThirdPartyLesson(ThirdPartyType.yuwen2017, 4, 48, "23. 祖先的摇篮"),
  ThirdPartyLesson(ThirdPartyType.yuwen2017, 4, 49, "24. 羿射九日"),
  ThirdPartyLesson(ThirdPartyType.yuwen2017, 4, 50, "25. 黄帝的传说"),
  ThirdPartyLesson(ThirdPartyType.yuwen2017, 4, 51, "W. 舟夜书所见"),
  ThirdPartyLesson(ThirdPartyType.yuwen2017, 4, 52, "X. 李时珍"),
];
