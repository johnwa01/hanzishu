...
var theExpandedComponentList = [
  ...
  ComponentCollection(1, "E24.png", 2, 4, getString(315)/*"square plus horizontal line"*/),
  ComponentCollection(2, "E13.png", 1, 3, getString(316)/*"which common shape"*/),
  ComponentCollection(3, "E23.png", 2, 3, getString(316)/*"which common shape"*/),
  ComponentCollection(4, "E53.png", 5, 3, getString(317)/*"containing a stroke with a few turns"*/),
  ComponentCollection(5, "E42.png", 4, 2, getString(318)/*"overall looking of the shape"*/),
  ComponentCollection(6, "E11.png", 1, 1, getString(319)/*"1st stroke or not fitting into others"*/),
  ComponentCollection(7, "E25.png", 2, 5, getString(320)/*"square plus a cross"*/),
  ComponentCollection(8, "E44.png", 4, 4, getString(316)/*"which common shape"*/),
  ComponentCollection(9, "E31.png", 3, 1, getString(321)/*"1st stroke or count of horizontal lines"*/),
  ComponentCollection(10, "E62.png", 6, 2, getString(322)/*"twisted triangle shape"*/),
  ComponentCollection(11, "E34.png", 3, 4, getString(323)/*"a curve crosses a horizontal line"*/),
  ComponentCollection(12, "E41.png", 4, 1, getString(319)/*"1st stroke or not fitting into others"*/),
  ComponentCollection(13, "E14.png", 1, 4, getString(324)/*"significant diagonal crosses"*/),
  ComponentCollection(14, "E22.png", 2, 2, getString(316)/*"which common shape"*/),
  ComponentCollection(15, "E43.png", 4, 3, getString(318)/*"overall looking of the shape"*/),
  ComponentCollection(16, "E52.png", 5, 2, getString(318)/*"overall looking of the shape"*/),
  ComponentCollection(17, "E61.png", 6, 1, getString(316)/*"which common shape"*/),
  ComponentCollection(18, "E12.png", 1, 2, getString(325)/*"separate or go left and right"*/),
  ComponentCollection(19, "E33.png", 3, 3, getString(326)/*"number of horizontal lines"*/),
  ComponentCollection(20, "E32.png", 3, 2, getString(326)/*"number of horizontal lines"*/),
  ComponentCollection(21, "E51.png", 5, 1, getString(327)/*"all but two first strokes are fold strokes"*/),
  ComponentCollection(22, "E54.png", 5, 4, getString(316)/*"which common shape"*/),
  ComponentCollection(23, "E15.png", 1, 5, getString(316)/*"which common shape"*/),
  ComponentCollection(24, "E21.png", 2, 1, getString(319)/*"1st stroke or not fitting into others"*/),
  ComponentCollection(25, "E35.png", 3, 5, getString(316)/*"which common shape"*/),
];
